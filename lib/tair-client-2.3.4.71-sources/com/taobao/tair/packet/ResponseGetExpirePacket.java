...
public class ResponseGetExpirePacket extends BasePacket {
	protected int             configVersion;
    protected List<DataEntry> entryList;
    protected int resultCode;
    protected List<DataEntry> proxiedKeyList;

    public ResponseGetExpirePacket(Transcoder transcoder) {
        super(transcoder);
        this.pcode = TairConstant.TAIR_RESP_GET_EXPIRE_EACKET;
    }
