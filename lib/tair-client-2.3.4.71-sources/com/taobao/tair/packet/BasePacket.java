...
public abstract class BasePacket 
	...
	public int getResultCode() {
		return ResultCode.CONNERROR.getCode();
	}
	...
	protected void fillMetas(ByteBuffer buffer) {
    	byte[] data = new byte[7];
		buffer.put(data);
	}
	...
	public int getConfigVersion() {
		// Do nothing
//		throw new UnsupportedOperationException("getConfigVersion");
		return 0;
	}
...
//		throw new UnsupportedOperationException("setVersion");
	...
	public void setExpire(int expire) {
		// Do nothing
//		throw new UnsupportedOperationException("setExpire");
	}
