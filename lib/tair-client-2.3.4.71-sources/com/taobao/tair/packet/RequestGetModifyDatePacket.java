...
public class RequestGetModifyDatePacket extends BasePacket {
    protected short namespace;
    protected int expired;
    protected Set<Object> keyList = new HashSet<Object>();

    public RequestGetModifyDatePacket(Transcoder transcoder) {
        super(transcoder);
        this.pcode = TairConstant.TAIR_REQ_GET_MODIFY_DATE_PACKET;
    }
