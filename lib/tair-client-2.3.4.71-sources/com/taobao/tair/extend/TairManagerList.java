...
public interface TairManagerList {
	 ...
	 * @return 返回成功或者失败错误码
	 */
	public Result<DataEntryLong> rpush(short namespace, Serializable key,
	...
	public Result<DataEntryLong> rpushLimit(short namespace, Serializable key,
			List<? extends Serializable> vals, int maxcount, short version, int expire);
	 ...
	 * @return 返回成功或者失败错误码
	 */
	public Result<DataEntryLong> lpush(short namespace, Serializable key,
			Serializable value, short version, int expire);
