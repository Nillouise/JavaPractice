...
public interface TairManagerCommon  {
	...
	public ResultCode addFilter(short namespace, Serializable keyPat, Serializable fieldPat, Serializable valuePat);
	
	public ResultCode removeFilter(short namespace, Serializable keyPat, Serializable fieldPat, Serializable valuePat);
	 ...
	 * @return
	 */
	public ResultCode setNamespaceAttr(short namespace, NSAttr attr, String value);
