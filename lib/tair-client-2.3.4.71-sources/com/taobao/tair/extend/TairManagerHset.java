...
public interface TairManagerHset {
	...
	public ResultCode hexists(short namespace, Serializable key, Serializable field);
	...
	public ResultCode hincrbyAsync(short namespace, Serializable key,
			Serializable field, int addvalue, short version, int expire, TairCallback cb);
	 ...
	 * @return 返回一个DataEntryMap，为成功插入的元素对
	 */
	...
	public ResultCode hdelAsync(short namespace, Serializable key, Serializable field,
