...
public class RequestSRemPacket extends BasePacket {
	...
	public RequestSRemPacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_REQ_SREM_PACKET;
	}

	public RequestSRemPacket() {
		super();
		pcode = TairConstant.TAIR_REQ_SREM_PACKET;
	}
