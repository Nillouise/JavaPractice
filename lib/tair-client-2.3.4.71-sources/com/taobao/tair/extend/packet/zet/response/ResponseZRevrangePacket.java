...
public class ResponseZRevrangePacket extends BasePacket {

	protected int configVersion = 0;
	protected short version = 0;
	protected int resultCode = 0;
	protected List<ValueScorePair> list = new ArrayList<ValueScorePair>();
	
	public ResponseZRevrangePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_RESP_ZREVRANGE_PACKET;
	}
	...
	public boolean decode() {
    	...
    	try {
	        ...
	        for (int i = 0; i < count; ++i) {
	        	...
	        	list.add(new ValueScorePair(ovalue, 0));
	        }
	...
	public List<ValueScorePair> getValues() {
		return list;
	}
	public void setData(List<ValueScorePair> list) {
		if (list == null) {
			return;
		}
		this.list = list;
