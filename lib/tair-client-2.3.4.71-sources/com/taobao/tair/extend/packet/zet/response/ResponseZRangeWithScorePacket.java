...
public class ResponseZRangeWithScorePacket extends ResponseZRangePacket {
	
	public ResponseZRangeWithScorePacket(Transcoder transcoder) {
		super(transcoder);
		pcode = TairConstant.TAIR_RESP_ZRANGEWITHSCORE_PACKET;
	}
