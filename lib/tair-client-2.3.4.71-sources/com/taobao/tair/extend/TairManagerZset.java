...
public interface TairManagerZset {
	 ...
	 */
	public Result<DataEntryList> zrange(short namespace, Serializable key, int start, int end, boolean withscore);
	 ...
	 */
	public Result<DataEntryList> zrevrange(short namespace, Serializable key, int start, int end, boolean withscore);
	...
	public Result<DataEntryList> zrangebyscore(short namespace,
			Serializable key, double min, double max, int limit, boolean withscore);
	...
	public ResultCode zaddAsync(short namespace, Serializable key, Serializable value,
			double score, short version, int expire, TairCallback cb);
	...
	public ResultCode zremAsync(short namespace, Serializable key, Serializable value,
	...
	public ResultCode zremrangebyscoreAsync(short namespace, Serializable key,
			double start, double end, short version, int expire,
			TairCallback cb);
	...
	public ResultCode zremrangebyrankAsync(short namespace, Serializable key,
			int start, int end, short version, int expire,
			TairCallback cb);
	...
	public ResultCode zincrbyAsync(short namespace, Serializable key,
			Serializable value, double addvalue, short version, int expire,
			TairCallback cb);
}
